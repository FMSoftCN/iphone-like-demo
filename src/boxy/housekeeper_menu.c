            ...
            void *context)
{
    ...
    printf ("housekeeper left = %d, MAINWINDOW_W = %d  \n", PMP_MENU_LEFT_X, MAINWINDOW_W);
    int dlg_rtn;
...
#ifdef BITMAPBK
    BITMAP* bmp_bks[4];
    bmp_bks[0] = (BITMAP *)RetrieveRes (housekeeper_pic[6]);
    bmp_bks[1] = (BITMAP *)RetrieveRes (housekeeper_pic[7]);
    bmp_bks[2] = (BITMAP *)RetrieveRes (housekeeper_pic[8]);
    bmp_bks[3] = (BITMAP *)RetrieveRes (housekeeper_pic[9]);
