...
int pmp_show_info(HWND h_parent_wnd, const char* title, const char* msg, DWORD dwStyle)
{
    ...
    bmp_parts.top_bmp = (BITMAP *)RetrieveRes (worm_menu_pic[1]);
    bmp_parts.mid_bmp = (BITMAP *)RetrieveRes (worm_menu_pic[2]);
    bmp_parts.btm_bmp = (BITMAP *)RetrieveRes (worm_menu_pic[3]);
#endif
    bmp_parts.top_bmp = (BITMAP *)RetrieveRes (worm_pic[7]);
    bmp_parts.mid_bmp = (BITMAP *)RetrieveRes (worm_pic[8]);
    bmp_parts.btm_bmp = (BITMAP *)RetrieveRes (worm_pic[9]);
